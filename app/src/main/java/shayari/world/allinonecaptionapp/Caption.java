...
public class Caption extends AppCompatActivity {
    ...
    void gridlist()
    {
        ...
        list.add ( new datax("Bikers" ,R.drawable.bicycle) );
...
class ImageAdapter extends BaseAdapter
{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate ( R.layout.gridfor_insta,parent,false );
        ...
        image.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                if(position==26)
                {
                    Intent intent = new Intent ( finalConvertView.getContext (),thanks_giving.class );
                    context.startActivity ( intent );
